...
const Featured = () => {
    const sliders = [
        ...
        {
            url: process.env.PUBLIC_URL+'/images/featured/burger_emxbtv.jpg'
          },
          {
            url: process.env.PUBLIC_URL+'/images/featured/pizza_osjb4f.jpg'
          },
          {
            url: process.env.PUBLIC_URL+'/images/featured/ric_a4ewxo.jpg',
          },
